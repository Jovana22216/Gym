<%-- 
    Document   : navbar
    Created on : Oct 24, 2020, 3:27:48 PM
    Author     : JOvana
--%>
    ...
    <style>
        ...
        *{
        ...
        .nav-item a{
         ...
         .background-image {
            position: fixed;
            background-image: url( 'https://images.unsplash.com/photo-1493690283958-32df2c86326e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=748&q=80' );
