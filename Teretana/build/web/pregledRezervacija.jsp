<%-- 
    Document   : pregledRezervacija
    Created on : Sep 8, 2020, 4:35:35 PM
    Author     : Jovana
--%>
    ...
    <body>
        ...
        <h1 align="center">REZERVACIJE</h1>
         <h2 id="poruka" align="center">
                <%      
                String naplata = (String) request.getAttribute("naplata");
                if (naplata != null) {
                %>
                <%= naplata%>
                <%
        ...
        <h2 id="poruka" align="center"><%
                String brisanjeRezervacije = (String) request.getAttribute("brisanjeRezervacije");
                if (brisanjeRezervacije != null) {
                %>
                <%= brisanjeRezervacije%>
                <%
                    }
        ...
        <h2 id="poruka" align="center"><%
            String kreiranjeRez = (String) request.getAttribute("kreiranjeRez");
            if (kreiranjeRez != null) {
            %>
            <%= kreiranjeRez%>
            <%
                }
        ...
        <form>
            ...
            <div style="width:94%; margin-left:3%">
                <table id="Tabela" class="table table-hover table-dark" style="background-color: #dae0e5; color:black;  font-family: Roboto;">
                    ...
                    <tbody>
                        <% String status = "Aktivna";
                            String Id = request.getParameter("korisnikId");
                            Korisnik k = new korisnikRepo().select(Id);
                            //String Idk = request.getParameter("teretanaId");
                            //Teretana teretana = new teretanaRepo().select(Idk);
                            int i = 1;
